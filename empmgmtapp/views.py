...
def salary_report(request):
    if request.method == 'POST':
        ...
        department_costs = Department.objects.annotate(
            total_cost=Sum('employee__employeesalary__salary', filter=Q(employee__employeesalary__date_range__start_date__lte=end_date, employee__employeesalary__date_range__end_date__gte=start_date))
